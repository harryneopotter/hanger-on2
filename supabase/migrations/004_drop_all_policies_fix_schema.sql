...
ALTER TABLE garment_images DROP CONSTRAINT IF EXISTS garment_images_garment_id_fkey;
ALTER TABLE garment_tags DROP CONSTRAINT IF EXISTS garment_tags_garment_id_fkey;
ALTER TABLE garment_tags DROP CONSTRAINT IF EXISTS garment_tags_tag_id_fkey;
ALTER TABLE collection_garments DROP CONSTRAINT IF EXISTS collection_garments_collection_id_fkey;
ALTER TABLE collection_garments DROP CONSTRAINT IF EXISTS collection_garments_garment_id_fkey;
ALTER TABLE collection_rules DROP CONSTRAINT IF EXISTS collection_rules_collection_id_fkey;
