            ...
            <div className="px-6 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm">
                <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Choose your preferred accent color</p>
                </div>
                <div className="p-6">
                    ...
                    {themeOptions.map((theme) => (
                      ...
                      >
                        <div className="flex flex-col items-center space-y-2">
                          <div className={`w-8 h-8 rounded-full ${theme.color} shadow-[2px_2px_4px_rgba(0,0,0,0.2)] ring-2 ring-white/50 dark:ring-gray-800/50`}></div>
                          <span className="text-xs font-medium text-gray-700 dark:text-gray-300 drop-shadow-sm">{theme.label}</span>
                        </div>
                        {selectedTheme === theme.name && (
